...
import { Users, BookOpen, Zap, Flag, TrendingUp, Shield } from "lucide-react";
import {
...
export default function AdminDashboard() {
  ...
  // If user is not admin, show a "Set as Admin" helper
  if (!user || user.role !== "admin") {
    return (
      <AdminShell userName={user?.displayName ?? "Guest"} onLogout={logout}>
